...
def check_input(finput, **kwargs):
	...
	n = get_integer(tokens[0], 1, 1000)

	times = []
	for i in xrange(0, n):
		tokens = get_line(finput, 1)
		t = get_integer(tokens[0], 0, 10000)
		if n == 0 and ("FIRST" in kwargs and kwargs["FIRST"] != t):
			return
		times.append(t)
...
if __name__ == "__main__":
	...
	for j in range(1, 4):
		...
		for i in range(1,101):
			...
			check_input_output(inp, outp, i, FIRST = 0)
