...
def check_input(finput, **kwargs):
	...
	e = get_integer(tokens[1], 1, kwargs['E'])
	...
	for i in xrange(0, e):
		tokens = get_line(finput, 2)
		v = get_integer(tokens[0], 1, n)
		if v in pos:
			error('position repeated')
		pos[v] = True
		d = get_integer(tokens[1], -1, 1)
		if d == 0:
...
if __name__ == "__main__":
	...
	for j in range(1, 5):
		...
		for i in range(1,101):
			...
			check_input_output(inp, outp, i, N = 100, E = 100)
	...
	for j in range(5, 11):
		...
		for i in range(1,101):
			...
			check_input_output(inp, outp, i, N = 1000000, E = 1000)
